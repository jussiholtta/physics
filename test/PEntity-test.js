...
describe("physicsApp.PEntity", function() {
    ...
    var angledEntity = new physicsApp.Entity(0,0,-10.0,-Math.sqrt(1/2), 0.5, 0.5, 10);

    afterEach(function() {
      entity = new physicsApp.Entity(0,0,-10,0,0,1, 10);
      angledEntity = new physicsApp.Entity(0,0,-10.0,-Math.sqrt(1/2), 0.5, 0.5, 10);
      });
